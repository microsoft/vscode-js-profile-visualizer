...
declare module 'vscode' {
  ...
  export namespace debug {
    ...
    export function registerDebugConfigurationProvider(
      ...
      scope?: DebugConfigurationProviderScope,
    ): Disposable;
  }
  ...
  export namespace window {
     ...
     */
    export function getEnvironmentVariableCollection(
      persistent?: boolean,
  ...
  export interface CustomEditorProvider<DocumentType extends CustomDocument = CustomDocument> {
    ...
    openCustomDocument(
      uri: Uri,
      openContext: OpenCustomDocumentContext,
      token: CancellationToken,
    ): Thenable<DocumentType> | DocumentType;
